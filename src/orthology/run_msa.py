"""
Run MAFFT on the strict PHF10 ortholog MSA input.

Purpose:
    Produce a reproducible first-pass multiple sequence alignment from
    the manually reviewed strict PHF10 ortholog FASTA.
...
Output files:
    ...
    data/interim/orthology/msa/msa_input_strict.mafft.log
    data/interim/orthology/msa/msa_input_strict.mafft.run.tsv
...
INPUT_FASTA = Path("data/interim/orthology/msa_input_strict.fasta")
OUTPUT_DIR = Path("data/interim/orthology/msa")
OUTPUT_ALIGNMENT = OUTPUT_DIR / "msa_input_strict.mafft.fasta"
LOG_FILE = OUTPUT_DIR / "msa_input_strict.mafft.log"
RUN_METADATA = OUTPUT_DIR / "msa_input_strict.mafft.run.tsv"
MAFFT_COMMAND = [
    "mafft",
    "--auto",
    str(INPUT_FASTA),
